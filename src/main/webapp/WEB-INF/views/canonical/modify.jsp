		...
		<div class="row">
			...
			<div class="box">
				<div class="box-header">
					<div class="well text-center">연혁 수정하기</div>
				</div>
				<div class="box-body">
								...
								<tbody>
									<tr>
										...
										<td colspan="3"><input type="text" class="form-control"
											name="f_title" value="${item.f_title }"></td>
									</tr>
									<tr>
										<th>연혁 년도</th>
										<td colspan="3"><input type="number" name="f_date"
											min="2011" step="1" value="${item.f_date }"></td>
									</tr>
									<tr>
										<th>내용</th>
										<td colspan="3"><a href="" class="btn btn-primary"
											id="addInputText">추가</a> <c:forEach items="${item2 }"
												var="item">
												<input type="text" name="f_comment"
													value="${item.f_comment }" class="form-control"
													placeholder="항목 이름">
												<script>
												f_id+="${item.f_id}"+",";
												</script>
					...
					<div class="col-md-12 text-center">
						<button type="button" class="btn btn-default" id="create">수정</button>
