					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								alt="User Image"> <span class="hidden-xs">관리자 </span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					<li class="active treeview"><a href="#" class="contentTitle"> <i
							class="fa fa-dashboard"></i> <span>대쉬보드</span>
					</a></li>
					<li class="treeview"><a class="contentTitle" href="/poll/list"> <i class="fa fa-files-o"></i>
							<span>팝업 관리</span> </span>
					</a></li>
					<li><a href="/board/list" class="contentTitle"> <i class="fa fa-edit"></i>
							<span class="coantentTitle">게시판 관리</span> </span>
					</a></li>
					<li class="treeview"><a class="contentTitle" href="/curriculumnHeader/list"> <i class="fa fa-list"></i>
							<span>교육과정 과목구분 관리</span> </span>
					</a></li>
					<li class="treeview"><a class="contentTitle" href="/curriculumnContent/list"> <i
							class="fa fa-list-alt"></i> <span>교육과정 관리</span> </span>
					</a></li>
					<li class="treeview"><a class="contentTitle" href="/statistics/list"> <i
							class="fa fa-pie-chart"></i> <span>접속 통계</span> </span>
					</a></li>
